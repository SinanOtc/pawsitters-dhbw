...
### 2026-05-18 - Frontend: Landing-Hero zweispaltig

- **Zweck**: Aus dem Design-System (claude.ai/design) das zweispaltige Hero-Layout der Landing Page nachziehen. Der bisherige Hero war zentriert mit kleinem H1 und wirkte gegen das neue Brand-Look „unfertig".
- **Prompt** (sinngemäß): Das Design-System hat noch einen viel auffälligeren Hero-Block — riesiges H1 mit Italic-Akzent in Terracotta, Foto-Platzhalter rechts, CTAs links-bündig. Im Kit ist das Bild ein abstrakter Caramel-Gradient mit oben gerundeter Form, plus eine weiße Pill-Label unten links. Kannst du das in unsere `home.html` reinbauen? Bestehende Inhalte (Headline, CTAs, Login-Hinweis) sollen bleiben, nur in eine `.hero-text`-Spalte rein, daneben ein neuer `.hero-photo`-Block. Mobile bitte auf eine Spalte umbrechen, sonst wird das auf dem Handy unleserlich.
